...
{
    public function testNegativeNumberOfDecimalsIsNotAllowed(): void
    {
    ...
    public function testToDecimalStringChecksThatFormatIsSensible(): void
    {
        $r = Rational::fromWhole(1);
    ...
    public function testToDecimalString1(): void
    {
    ...
    public function testToDecimalString2(): void
    {
        $r = Rational::fromWhole(-10);
        $this->assertEquals('-10', $r->toDecimalString(3, 0,  Rational::TO_DECIMAL_CEIL));
        $this->assertEquals('-10', $r->toDecimalString(3, 0,  Rational::TO_DECIMAL_ROUND_HALF_UP));
    ...
    public function testToDecimalString3(): void
    {
        $r = Rational::fromWhole(-10);
    ...
    public function testToDecimalString4(): void
    {
    ...
    public function testToDecimalString5(): void
    {
    ...
    public function testToDecimalString6(): void
    {
        $r = Rational::fromWholeAndFraction(2, 1, 4);
    ...
    public function testToDecimalString7(): void
    {
        $r = Rational::fromWholeAndFraction(2, 3, 4);
    ...
    public function testToDecimalString8(): void
    {
        $r = Rational::fromWholeAndFraction(2, 3, 4);
    ...
    public function testToDecimalString9(): void
    {
    ...
    public function testToDecimalString10(): void
    {
    ...
    public function testToDecimalString11(): void
    {
        $r = Rational::fromWholeAndFraction(-3, -999, 1000);
    ...
    public function testToDecimalString12(): void
    {
    ...
    public function testToDecimalString13(): void
    {
        $r = Rational::zero();
    ...
    public function testToDecimalString14(): void
    {
    ...
    public function testToDecimalString15(): void
    {
        $r = Rational::fromWholeAndFraction(-3, -1, 2);
        $this->assertEquals('-3', $r->toDecimalString(0, 0, Rational::TO_DECIMAL_CEIL));
        $this->assertEquals('-4', $r->toDecimalString(0, 0, Rational::TO_DECIMAL_ROUND_HALF_UP));
    ...
    public function testToDecimalString16(): void
    {
    ...
    public function testToDecimalString17(): void
    {
        $r = Rational::fromFraction(-1, 1000);
    ...
    public function testFormatIntegerWithForcedNumberOfDecimals(): void
    {
        $r = Rational::fromWhole(5);
        $this->assertSame('5.00', $r->format(2, 2));
    }

    public function testFormatDecimalWithForcedNumberOfDecimals(): void
    {
        $r = Rational::fromWholeAndFraction(5, 1, 10);
        $this->assertSame('5.10', $r->format(2, 2));
    }

    public function testFormatRationalWithMinAndMaxDecimalValues(): void
    {
